...
const verifySuspect = async (req, res) => {
  try {
    ...
    const suspectData = {
      ...
      // hit routes/policeGuestPhotoRoutes.js, which re-checks the police
      // JWT and audit-logs the view on every request.
      photos: {
        guestPhoto: guest.getPhotoUrl("guestPhoto"),
        idFront: guest.getPhotoUrl("idFront"),
        idBack: guest.getPhotoUrl("idBack"),
      },
    };
